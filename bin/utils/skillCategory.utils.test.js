...
const skillCategory_utils_1 = require("./skillCategory.utils");
(0, vitest_1.describe)("categorizeSkills", () => {
    (0, vitest_1.it)("groups skills into their matching category", () => {
        const result = (0, skillCategory_utils_1.categorizeSkills)([
    ...
    (0, vitest_1.it)("returns empty categories for an empty list", () => {
        (0, vitest_1.expect)((0, skillCategory_utils_1.categorizeSkills)([])).toEqual({
            nonCode: [],
            coreCode: [],
            react: [],
            vue: [],
    ...
    (0, vitest_1.it)("treats an unknown skill as core code", () => {
        const result = (0, skillCategory_utils_1.categorizeSkills)(["some-new-skill"]);
...
(0, vitest_1.describe)("NON_CODE_SKILLS", () => {
    (0, vitest_1.it)("contains the known non-code skill names", () => {
        (0, vitest_1.expect)(skillCategory_utils_1.NON_CODE_SKILLS.has("shortcuts")).toBe(true);
        (0, vitest_1.expect)(skillCategory_utils_1.NON_CODE_SKILLS.has("code-change")).toBe(false);
    });
});
