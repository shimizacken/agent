...
description: 'Code formatting rules for React and TypeScript/JavaScript web apps. Use when writing or reviewing frontend code. Covers brace style, blank line placement between declarations, statements, and returns.'
---
